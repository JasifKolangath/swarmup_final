...
public class Slave implements Runnable {
	...
	private MainSwarm queenbee = null;
...
//	private JobParams jobParams = null;
	...
	public Slave(boolean pSelf, boolean pWorker, Context pAct, JobParams pMsg, MainSwarm pBee) {// delegator stolen work
		this.isSelf = pSelf;
		this.isWorker = pWorker;
		jobList = new LinkedList<Job>();
		doneJobs = new ArrayList<CompletedJob>();
	...
	public Slave(boolean pSelf, boolean pWorker, Context pAct, MainSwarm pBee) {//facematch initial delegator work
		this.isSelf = pSelf;
		this.isWorker = pWorker;
		jobList = new LinkedList<Job>();
		doneJobs = new ArrayList<CompletedJob>();
...
//		MainSwarm bee = new MainSwarm((Activity)parentActivity);//niro
