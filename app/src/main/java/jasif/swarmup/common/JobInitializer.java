...
public class JobInitializer {
	 ...
	 * @return
	 */
	public static JobInitializer getInstance(int pNodes, Activity pAct) {
		// should only be called in the Delegating class
	...
	public Runnable assignStolenJobsForDelegator(boolean isDeleWork,
			JobParams pMsg, MainSwarm pBee) throws IOException {
	...
	public Runnable assignAddebBackJobsForDelegator(boolean isDeleWork,
			MainSwarm pBee) throws IOException {
	...
	private Runnable assignJobsForDelegator(boolean isDeleWork,
			String pActClass, MainSwarm pBee) throws IOException {
	...
	public Runnable assignJobs(boolean isOwnWork, boolean isDelegator,
			String pActClassDelegator, MainSwarm pBee) throws IOException {
